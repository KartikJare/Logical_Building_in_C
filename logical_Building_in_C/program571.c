...
void Insert(PPNODE first,int no)
{
    ...
    else               // BST contain atleast 1 node
    {
        temp = *first;
...
bool Search(PNODE first, int no)
{
    ...
    printf("Time complexity of sreach is : %d\n",TimeComplextiy);
    return bFlag;
}
...
int CountLeafNode(PNODE first)
{
    ...
    {   
        ...
        CountLeafNode(first->rchild);   //Important
...
int CountParentNode(PNODE first)
{
    ...
    {   
        ...
        CountParentNode(first->rchild);   //Important
